    ...
    return ClipRRect(
      ...
      child: Stack(
        children: [
          ...
          piece(14, 14, 10, 4, 0.35, const Color(0xFFFFD76A), BorderRadius.circular(10)),
          piece(52, 28, 6, 6, 0.0, const Color(0xFFF2BC35), BorderRadius.circular(999)),
          piece(98, 12, 12, 4, -0.45, const Color(0xFF8B6813), BorderRadius.circular(10)),
          piece(145, 20, 8, 8, 0.0, const Color(0xFFFFC400), BorderRadius.circular(999)),
          piece(188, 14, 10, 4, 0.6, const Color(0xFFFFE08A), BorderRadius.circular(10)),
          piece(232, 26, 7, 7, 0.0, const Color(0xFFF2BC35), BorderRadius.circular(999)),
          piece(278, 16, 11, 4, -0.3, const Color(0xFF8B6813), BorderRadius.circular(10)),
          piece(320, 24, 6, 6, 0.0, const Color(0xFFFFD76A), BorderRadius.circular(999)),
          piece(366, 12, 10, 4, 0.4, const Color(0xFFFFC400), BorderRadius.circular(10)),
          piece(410, 20, 7, 7, 0.0, const Color(0xFFFFE08A), BorderRadius.circular(999)),
          piece(24, 54, 8, 8, 0.0, const Color(0xFFF2BC35), BorderRadius.circular(999)),
          piece(118, 62, 9, 4, -0.55, const Color(0xFFFFD76A), BorderRadius.circular(10)),
          piece(212, 56, 8, 8, 0.0, const Color(0xFFFFC400), BorderRadius.circular(999)),
          piece(304, 60, 10, 4, 0.5, const Color(0xFF8B6813), BorderRadius.circular(10)),
          piece(396, 54, 8, 8, 0.0, const Color(0xFFF2BC35), BorderRadius.circular(999)),
        ],
      ),
    );
  }
