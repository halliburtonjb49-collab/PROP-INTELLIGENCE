...
| --- | --- | ---: | ---: | --- |
| Core Monthly | `com.propintelligence.app.core.monthly` | $24.99/month | 2 days | `core` |
| Core Annual | `com.propintelligence.app.core.annual` | $249.99/year | 7 days | `core` |
| Pro Monthly | `com.propintelligence.app.pro.monthly` | $59.99/month | 2 days | `pro` |
| Pro Annual | `com.propintelligence.app.pro.annual` | $599.99/year | 7 days | `pro` |
| Founding Pro Monthly | `com.propintelligence.app.founding_pro.monthly` | $49.99/month | 2 days | `pro` plus founding-member identity |
| Founding Pro Annual | `com.propintelligence.app.founding_pro.annual` | $499.99/year | 7 days | `pro` plus founding-member identity |
